            ...
            <nav className="hidden md:block">
                <ul className="flex justify-between items-center w-full">
                    ...
                    <div className="flex mr-4">
                        <li><button className="bg-nav-buttons hover:bg-buttons-hover p-3 m-3 rounded-full w-[125px] h-[45px] flex justify-center items-center hover:text-white"><Link href="/">Homebanking</Link></button></li>
                        <li><button className="bg-nav-buttons hover:bg-buttons-hover p-3 m-3 rounded-full w-[125px] h-[45px] flex justify-center items-center hover:text-white"><Link href="/">Registrate</Link></button></li>
                    </div>
